...
import static spideymod.SpideyMod.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {
    
    public static final String ID = SpideyMod.makeID("IdentityCrisisEvent");
            ...
            case 0:
                switch (i) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        imageEventText.loadImage("spideymodResources/images/events/IdentityCrisisEvent2.png");
